...
const { create: createPanResponder = noop } = PanResponder || {}
const defaultPanResponder = createPanResponder({})
...
export class Router extends React.Component {
  ...
  renderScene (props) {
    ...
    const render = route.renderPage || ((Component, route) => (
      <Component {...(route.pass || {})} url={route.url} route={route} />
    ))
    const handlers = Object.assign(
        {},
        defaultPanResponder.panHandlers,
        transitions.handlers.call(CurrentPage, passedProps))
    ...
    return (
      <Navigation.Card
        ...
        renderScene={props => render(CurrentPage, route)}
        />
    )
  }
